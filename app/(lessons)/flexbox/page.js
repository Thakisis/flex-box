  ...
  return (
    <main className="m-10 font-[family-name:var(--font-geist-sans)] ">
      <section className="space-y-4 mb-12">
        ...
        <p>los elementos con display block se colocaban uno debajo del otro</p>
      ...
      <section className="space-y-4">
        ...
        <p>
          Esto permite a los elementos de contenidos de ser alineados de manera
          flexible y dinámica, lo que resulta útil para crear diseños de
          interfaz de usuario (UI) que se adapten a diferentes tamaños de
          pantalla y resoluciones de pantalla.
        </p>

        <div className="grid grid-cols-2 gap-4 items-center place-items-center">
          <div>
            <h3 className="w-full p-2 text-center">usando display block-inline</h3>
          <div className="p-6 rounded-lg shadow-lg max-w-lg border-2 border-dashed border-gray-400 bg-orange-500/20">
